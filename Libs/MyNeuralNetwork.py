...
"""
* 定義済みニューラルネットワークモデル
 - Deep Neural Network (Dataset:MNIST)
 - Convolutional Neural Network (Dataset:CIFAR-10)
 - vgg16 (Dataset:CIFAR-10)
 - vgg19 (Dataset:CIFAR-10)
 - ResNet34 (Dataset:CIFAR-10)
 - WideResNet (Dataset:CIFAR-10)
"""
